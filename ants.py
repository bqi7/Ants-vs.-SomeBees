...
class Place(object):
    ...
    def remove_insect(self, insect):
        ...
        Place, an AssertonError is raised.
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        while place is not hive:
            if len(place.bees) > 0 and setter >= self.min_range and setter <= self.max_range:
            ...
            while place.exit != None:
                ...
                if ant:
                    if ant not in self.doubled_ants:
                        ...
                        ant.damage *= 2
                    if ant.container and ant.ant and ant.ant not in self.doubled_ants:
...
def apply_effect(effect, bee, duration):
    ...
    affected_bee_action = effect(original_bee_action)
